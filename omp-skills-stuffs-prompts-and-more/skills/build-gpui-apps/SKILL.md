...
| Faithfully translate a selected Paper.design frame as the primary task | Use [paper-to-gpui.md](references/paper-to-gpui.md) with [paper-mcp.md](references/paper-mcp.md) | Return here only for broader app architecture or production work |
...
primary task, use the local [Paper translation reference](references/paper-to-gpui.md) and its source/visual checks. No standalone paper-to-gpui skill is required.
